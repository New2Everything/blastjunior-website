...
| 任务 | 状态 |
|------|------|
| Worker API 支持标签 CRUD | ✅ 完成 |
| 前端展示和打标功能 | ✅ 完成 |
| profile 页面增加管理后台入口 | ✅ 完成 |
| photo-admin 页面 | ✅ 完成 |
...
|------|------|
| 赞助商缺图时自动隐藏卡片 | ✅ 完成 |
| 首页赞助商图片404修复（路径从/media/web改为/media） | ✅ 完成 |
| Poster页面首屏不加载每张照片的tags，改为按需加载 | ✅ 完成 |
| 移除重复的loadHomeData调用 | ✅ 完成 |

...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-conversion-design.keep-visual-design-energetic-but-structu-20260520-092130",\n  "target_family": "conversion-design.keep-visual-design-energetic-but-structu",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 2,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "conversion-design_keep-visual-design-energetic-but-structu_probe",\n  "recommended_probe_script": "learning-v2-conversion-design-keep-visual-design-energetic-but-structu-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile."\n  ],\n  "source_titles": [\n    "12 real CRO case studies & examples for 2025 (with results) - Unbounce",\n    "Educational advertorial landing page boosts parent engagement and ..."\n  ],\n  "score": 200,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-conversion-design-keep-visual-design-energetic-but-structu-probe.py"\n  ],\n  "jsonl_line": 12\n}')

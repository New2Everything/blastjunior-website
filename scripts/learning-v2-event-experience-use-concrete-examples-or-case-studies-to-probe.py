...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-event-experience.use-concrete-examples-or-case-studies-to-20260520-114619",\n  "target_family": "event-experience.use-concrete-examples-or-case-studies-to",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 1,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "event-experience_use-concrete-examples-or-case-studies-to_probe",\n  "recommended_probe_script": "learning-v2-event-experience-use-concrete-examples-or-case-studies-to-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Use concrete examples or case studies to help visitors understand what good participation looks like."\n  ],\n  "source_titles": [\n    "Event Landing Page Examples: 20 Real Designs That Convert - SeedProd"\n  ],\n  "score": 190,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-event-experience-use-concrete-examples-or-case-studies-to-probe.py"\n  ],\n  "jsonl_line": 19\n}')

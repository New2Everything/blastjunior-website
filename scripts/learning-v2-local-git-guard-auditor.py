...
REQUIRED_HOOKS = {
    "pre-commit": {
        "must_contain": [
            ...
            "scripts/learning-v2-business-only-commit-gate.py",
            "scripts/learning-v2-opportunity-business-only-commit-gate.py",
            "ok_for_commit",
            "git commit blocked",
            "opportunity-business-only",
            "dedicated local commit gate passed",
...
def main():
    ...
    report = {
        ...
        "policy": {
            ...
            "commit_expected_now": "normal blocked; local commit allowed only when system-only, business-only, or opportunity-business-only dedicated gate passes",

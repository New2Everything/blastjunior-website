...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-event-experience.show-participation-pathways-clearly-so-c-20260520-103803",\n  "target_family": "event-experience.show-participation-pathways-clearly-so-c",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 2,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "event-experience_show-participation-pathways-clearly-so-c_probe",\n  "recommended_probe_script": "learning-v2-event-experience-show-participation-pathways-clearly-so-c-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Show participation pathways clearly so community members know how to join, contribute, or stay involved.",\n    "Show participation pathways clearly so community members know how to join, contribute, or stay involved."\n  ],\n  "source_titles": [\n    "Sports Technology UX Design: Enhancing User Experience in Sports ...",\n    "UX for Event Websites: Registration, Schedules, and Engagement"\n  ],\n  "score": 200,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-event-experience-show-participation-pathways-clearly-so-c-probe.py"\n  ],\n  "jsonl_line": 18\n}')

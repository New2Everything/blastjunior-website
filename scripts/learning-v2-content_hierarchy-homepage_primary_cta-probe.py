...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-content_hierarchy.homepage_primary_cta-20260520-092130",\n  "target_family": "content_hierarchy.homepage_primary_cta",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 15,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "content_hierarchy_homepage_primary_cta_probe",\n  "recommended_probe_script": "learning-v2-content_hierarchy-homepage_primary_cta-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Make the first successful action obvious and reduce setup friction for new users.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Make the first successful action obvious and reduce setup friction for new users.",\n    "Use concrete examples or case studies to help visitors understand what good participation looks like.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Show participation pathways clearly so community members know how to join, contribute, or stay involved.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Use concrete examples or case studies to help visitors understand what good participation looks like.",\n    "Show participation pathways clearly so community members know how to join, contribute, or stay involved.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Use concrete examples or case studies to help visitors understand what good participation looks like.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile."\n  ],\n  "source_titles": [\n    "An information architecture case study | Lauren Pope: La Pope Ltd",\n    "Best sports websites | Web Design Inspiration - Awwwards",\n    "Content Hierarchy 101: How to Structure Your Website for Success",\n    "Content hierarchy: What it is and why you need it - Bynder",\n    "Jaw-Dropping Sports Website Design Examples"\n  ],\n  "score": 330,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-content_hierarchy-homepage_primary_cta-probe.py"\n  ],\n  "jsonl_line": 10\n}')

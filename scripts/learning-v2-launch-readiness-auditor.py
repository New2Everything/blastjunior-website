...
def main():
    ...
    rc8, report8, out8, err8 = run(["python3", str(CONTENT_CONTROLLED_APPLY_SMOKE)])
    add("content_controlled_apply_readiness_smoke", rc8 == 0 and bool(report8), report8 or "missing_report")

...
def main():
    ...
    if current_topic or current_stage or current_target_family:
        ...
        if (
            ...
            and latest_controlled_source_change_git_push_gate.get("git_push_allowed") is False
            and latest_controlled_source_change_git_push_gate.get("actual_source_written") is False
        ):
            ...
            allowed_actions.append("controlled_source_change_cloudflare_pages_status_check_dry_run")
            blocked_actions.extend([
                "source_discovery",
                "new_candidate_generation",
                "website_source_change",
    ...
    payload = {
        ...
        "latest_controlled_source_change_git_push_gate": {
            "path": str(latest_controlled_source_change_git_push_gate_path) if latest_controlled_source_change_git_push_gate_path else None,
            "gate_status": latest_controlled_source_change_git_push_gate.get("gate_status"),

...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-conversion-design.use-concrete-examples-or-case-studies-to-20260520-092130",\n  "target_family": "conversion-design.use-concrete-examples-or-case-studies-to",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 1,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "conversion-design_use-concrete-examples-or-case-studies-to_probe",\n  "recommended_probe_script": "learning-v2-conversion-design-use-concrete-examples-or-case-studies-to-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Use concrete examples or case studies to help visitors understand what good participation looks like."\n  ],\n  "source_titles": [\n    "12 real CRO case studies & examples for 2025 (with results) - Unbounce"\n  ],\n  "score": 190,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-conversion-design-use-concrete-examples-or-case-studies-to-probe.py"\n  ],\n  "jsonl_line": 14\n}')

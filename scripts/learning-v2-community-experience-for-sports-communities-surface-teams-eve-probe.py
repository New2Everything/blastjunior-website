...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-community-experience.for-sports-communities-surface-teams-eve-20260520-073414",\n  "target_family": "community-experience.for-sports-communities-surface-teams-eve",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 5,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "community-experience_for-sports-communities-surface-teams-eve_probe",\n  "recommended_probe_script": "learning-v2-community-experience-for-sports-communities-surface-teams-eve-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act."\n  ],\n  "source_titles": [\n    "15 sports website examples that get it right - Wix.com",\n    "50 Free Sports Website Templates For Clubs & Events 2026",\n    "Case Study Club - Learn how people design digital products",\n    "Case studies - Community Engagement Hub",\n    "Go Vocal case studies: Community engagement success stories"\n  ],\n  "score": 230,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-community-experience-for-sports-communities-surface-teams-eve-probe.py"\n  ],\n  "jsonl_line": 3\n}')

...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-community-experience.reduce-early-cognitive-load-by-sequencin-20260520-073414",\n  "target_family": "community-experience.reduce-early-cognitive-load-by-sequencin",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 1,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "community-experience_reduce-early-cognitive-load-by-sequencin_probe",\n  "recommended_probe_script": "learning-v2-community-experience-reduce-early-cognitive-load-by-sequencin-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Reduce early cognitive load by sequencing setup tasks clearly."\n  ],\n  "source_titles": [\n    "Onboarding UX Design Case Study — Outreach"\n  ],\n  "score": 190,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-community-experience-reduce-early-cognitive-load-by-sequencin-probe.py"\n  ],\n  "jsonl_line": 6\n}')

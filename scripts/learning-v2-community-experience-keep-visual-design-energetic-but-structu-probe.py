...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-community-experience.keep-visual-design-energetic-but-structu-20260520-073414",\n  "target_family": "community-experience.keep-visual-design-energetic-but-structu",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 3,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "community-experience_keep-visual-design-energetic-but-structu_probe",\n  "recommended_probe_script": "learning-v2-community-experience-keep-visual-design-energetic-but-structu-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile.",\n    "Keep visual design energetic but structured, with responsive sections that remain readable on mobile."\n  ],\n  "source_titles": [\n    "15 sports website examples that get it right - Wix.com",\n    "Case Study Club - Learn how people design digital products",\n    "Case studies - Community Engagement Hub"\n  ],\n  "score": 210,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-community-experience-keep-visual-design-energetic-but-structu-probe.py"\n  ],\n  "jsonl_line": 4\n}')

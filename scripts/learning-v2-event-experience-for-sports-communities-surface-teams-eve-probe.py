...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-event-experience.for-sports-communities-surface-teams-eve-20260520-103803",\n  "target_family": "event-experience.for-sports-communities-surface-teams-eve",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 3,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "event-experience_for-sports-communities-surface-teams-eve_probe",\n  "recommended_probe_script": "learning-v2-event-experience-for-sports-communities-surface-teams-eve-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act.",\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act."\n  ],\n  "source_titles": [\n    "FOX Sports Sporting Events UI UX Design | Sports & Media",\n    "Sports Technology UX Design: Enhancing User Experience in Sports ...",\n    "UX for Event Websites: Registration, Schedules, and Engagement"\n  ],\n  "score": 210,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-event-experience-for-sports-communities-surface-teams-eve-probe.py"\n  ],\n  "jsonl_line": 15\n}')

...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-conversion-design.show-participation-pathways-clearly-so-c-20260520-092130",\n  "target_family": "conversion-design.show-participation-pathways-clearly-so-c",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 1,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "conversion-design_show-participation-pathways-clearly-so-c_probe",\n  "recommended_probe_script": "learning-v2-conversion-design-show-participation-pathways-clearly-so-c-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Show participation pathways clearly so community members know how to join, contribute, or stay involved."\n  ],\n  "source_titles": [\n    "Educational advertorial landing page boosts parent engagement and ..."\n  ],\n  "score": 190,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-conversion-design-show-participation-pathways-clearly-so-c-probe.py"\n  ],\n  "jsonl_line": 13\n}')

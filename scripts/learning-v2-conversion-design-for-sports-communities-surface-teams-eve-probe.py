...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-conversion-design.for-sports-communities-surface-teams-eve-20260520-092130",\n  "target_family": "conversion-design.for-sports-communities-surface-teams-eve",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 1,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "conversion-design_for-sports-communities-surface-teams-eve_probe",\n  "recommended_probe_script": "learning-v2-conversion-design-for-sports-communities-surface-teams-eve-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "For sports communities, surface teams, events, membership, and proof of activity before asking users to act."\n  ],\n  "source_titles": [\n    "12 real CRO case studies & examples for 2025 (with results) - Unbounce"\n  ],\n  "score": 190,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-conversion-design-for-sports-communities-surface-teams-eve-probe.py"\n  ],\n  "jsonl_line": 11\n}')

...
CANDIDATE = json.loads('{\n  "candidate_id": "candidate-community-experience.make-the-first-successful-action-obvious-20260520-073414",\n  "target_family": "community-experience.make-the-first-successful-action-obvious",\n  "topic": "research-derived",\n  "risk": "low",\n  "pattern_count": 3,\n  "activation_allowed_now": true,\n  "activation_status": "candidate_ready_for_observe_only_probe_design",\n  "observe_only_first": true,\n  "recommended_stage": "community-experience_make-the-first-successful-action-obvious_probe",\n  "recommended_probe_script": "learning-v2-community-experience-make-the-first-successful-action-obvious-probe.py",\n  "recommended_probe_script_exists": false,\n  "principles": [\n    "Make the first successful action obvious for new users.",\n    "Make the first successful action obvious and reduce setup friction for new users.",\n    "Make the first successful action obvious and reduce setup friction for new users."\n  ],\n  "source_titles": [\n    "50 Free Sports Website Templates For Clubs & Events 2026",\n    "Go Vocal case studies: Community engagement success stories",\n    "Onboarding UX Design Case Study — Outreach"\n  ],\n  "score": 210,\n  "selector_ready": false,\n  "blockers": [\n    "recommended_probe_script_missing:learning-v2-community-experience-make-the-first-successful-action-obvious-probe.py"\n  ],\n  "jsonl_line": 5\n}')
